...
class QAModel(nn.Module):
    def __init__(self, bert_model_name='deepset/bert-base-cased-squad2'):
        super().__init__()
...
model = QAModel(bert_model_name='deepset/bert-base-cased-squad2')
...
print("WER (fine-tuned model) - ",wer_list)
